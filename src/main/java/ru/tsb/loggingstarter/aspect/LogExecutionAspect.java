package ru.tsb.loggingstarter.aspect;
...
import ru.tsb.loggingstarter.annotation.LogExecutionTime;
...
public class LogExecutionAspect {
    ...
    @Around("@annotation(ru.tsb.loggingstarter.annotation.LogExecutionTime)")
